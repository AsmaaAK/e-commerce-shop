    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Any questions? Let us know at 8th floor, 379 Hudson St, New York, NY 10018 or call (+1) 96 716 6879
                </p>
                <div class="p-t-27">
        ...
        <div class="p-t-40">
            <div class="flex-c-m flex-w p-b-18">
                <a href="#"><img src="{{ asset('images/icons/icon-pay-01.png') }}" alt="Payment"></a>
                <a href="#"><img src="{{ asset('images/icons/icon-pay-02.png') }}" alt="Payment"></a>
                <a href="#"><img src="{{ asset('images/icons/icon-pay-03.png') }}" alt="Payment"></a>
                <a href="#"><img src="{{ asset('images/icons/icon-pay-04.png') }}" alt="Payment"></a>
                <a href="#"><img src="{{ asset('images/icons/icon-pay-05.png') }}" alt="Payment"></a>
            </div>

            <p class="stext-107 cl6 txt-center">
                &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
            </p>
        </div>
    </div>
</footer>
